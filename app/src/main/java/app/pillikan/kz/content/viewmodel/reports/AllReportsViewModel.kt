package app.pillikan.kz.content.viewmodel.reports
...
import app.pillikan.kz.content.model.repository.reports.AllReportsRepository
import app.pillikan.kz.content.model.response.reports.ReportsItems

class AllReportsViewModel(application: Application) : AndroidViewModel(application) {

    private val repository = AllReportsRepository(application)
